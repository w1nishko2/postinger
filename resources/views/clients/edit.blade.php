                    ...
                    <form action="{{ route('clients.update', $client) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('telegram_user_id') is-invalid @enderror" 
                                   id="telegram_user_id" name="telegram_user_id" value="{{ old('telegram_user_id', $client->telegram_user_id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3">{{ old('description', $client->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
